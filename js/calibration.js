...
function PopUpInstruction(){
  ...
  swal({
    title:"Calibration",
    text: "Please click on each of the 9 points on the screen. You must click on each point 10 times till it goes yellow. This will calibrate your eye movements.",
    buttons:{
      cancel: false,
      confirm: true
    }
...
function showJoinCallBtn() {
  var joinCallBtn = document.getElementById('join-btn');
...
if(isCalibrated){document.getElementById('join-btn').addEventListener('click', function() {
  var urlParams = new URLSearchParams(window.location.search);
  var inviteCode = urlParams.get('room');
